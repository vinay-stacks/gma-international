...
export default function WhyChooseGma() {
  const leftFeatures = [
    {
      text: "Student-Centered Curriculum",
    ...
    {
      text: "Global Outlook with Indian Values",
      color: "bg-gradient-to-r from-purple-500 to-pink-500",
    },
    {
      text: "Experiential Learning Methods",
      color: "bg-gradient-to-r from-orange-500 to-red-500",
    },
    {
      text: "Culture of Excellence",
  ...
  const rightFeatures = [
    {
      text: "Personalized Academic Support",
      color: "bg-gradient-to-r from-orange-500 to-red-500",
    },
    {
      text: "Interactive & Inspiring Classrooms",
      color: "bg-gradient-to-r from-yellow-400 to-green-400",
    },
    {
      text: "Exploration Beyond Textbooks (ATL)",
      color: "bg-gradient-to-r from-red-500 to-orange-500",
    },
    {
      text: "Future-Ready K–12 Infrastructure",
      color: "bg-gradient-to-r from-cyan-400 to-blue-400",
    },
    {
      text: "Outstanding Board Results",
      color: "bg-gradient-to-r from-emerald-500 to-teal-600",
    },
  ];

  return (
    <div className="relative overflow-hidden bg-cover bg-center bg-fixed"
      style={{ backgroundImage: "url('/images/why-choose-bg.webp')" }} // Replace with your image path
    >
        ...
        <div className="text-center mb-8 lg:mb-16">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg lg:text-xl text-white/90 leading-relaxed px-4">
              At GMA International School, we nurture global citizens with
              strong values, academic excellence, and a lifelong love for
              learning. Our student-centric approach blends innovation with
              tradition, ensuring each child receives personalized guidance in a
              safe, inclusive environment.
            </p>
            <p className="text-lg lg:text-xl text-white/90 leading-relaxed mt-2 px-4">
              With a curriculum designed for holistic development and
              21st-century skills, GMA International is more than just a school
              — it’s a foundation for future leaders.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16 xl:gap-24">
          ...
          <div className="flex flex-col space-y-2 lg:space-y-6 order-2 lg:order-1">
            {leftFeatures.map((feature, index) => (
              <div key={index} className="flex justify-center lg:justify-end">
                <div
                  className={`${feature.color} rounded-full px-6 py-3 lg:px-8 lg:py-4 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 cursor-pointer`}
                >
          ...
          <div className="flex-shrink-0 order-1 lg:order-2">
            <div className="relative">
              <div className="w-64 h-64 lg:w-80 lg:h-80 xl:w-96 xl:h-96 rounded-full bg-[#cdc072] p-2 shadow-2xl">
